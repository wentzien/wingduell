...
<body>
 <div data-role="header" id="header" data-position="fixed" class="ui-header ui-bar-inherit ui-header-fixed slidedown ui-fixed-hidden">
   ...
   <div id="menu">
       	  ...
       	  <a href="?task=neuesspiel" data-role="button" data-icon="gamepad" data-mini="true" data-iconpos="notext" data-inline="true" class="ui-link ui-btn ui-icon-gamepad ui-btn-icon-notext ui-btn-inline ui-shadow ui-corner-all ui-mini"></a>
          
    </div>

    <div id="menu">
        
       	  <a href="?task=statistik" data-role="button" data-icon="gamepad" data-mini="true" data-iconpos="notext" data-inline="true" class="ui-link ui-btn ui-icon-star ui-btn-icon-notext ui-btn-inline ui-shadow ui-corner-all ui-mini"></a>
          
    </div>       
     
     </div>
    <div style="height:8px"></div>
    <center><lable> Fordere andere Wing's heraus um der beste Wing zu werden</lable></center>
